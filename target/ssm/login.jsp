        ...
        <form class="form form-horizontal" action="${pageContext.request.contextPath}/login.do" method="post">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-8">
                    <input id="usernameid" name="username" type="text" placeholder="账户" class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
            ...
            <div class="row cl">
                <div class="formControls col-8 col-offset-3">
                    ...
                    <img src=""> <a href="javascript:;">看不清，换一张</a></div>
            </div>
            <div class="row">
                <div class="formControls col-8 col-offset-3">
                    <label for="online">
...
<div class="footer">Copyright 汇才同飞 by www.javakc.com</div>
